...
Example jobs that are not implementing complete pipelines, but demonstrate ideas, or single steps/stages of the larger pipelines. They can serve as "sippets" to be included into existing jobs. Currently these are:
